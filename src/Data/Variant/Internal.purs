...
instance VariantMatchCases RL.Nil () b
...
instance VariantMapCases RL.Nil () ()
...
instance VariantFMapCases RL.Nil () () a b
...
instance VariantTraverseCases m RL.Nil () ()
...
instance VariantFTraverseCases m RL.Nil () () a b
...
instance VariantTags RL.Nil where
  variantTags _ = L.Nil

instance (VariantTags rs, IsSymbol sym) ⇒ VariantTags (RL.Cons sym a rs) where
